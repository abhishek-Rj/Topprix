                ...
                <div className="w-full md:w-1/2 p-8 bg-white rounded-xl shadow-xl">
                    ...
                    <form className="mt-6 space-y-4" onSubmit={handleSignUp}>
                        ...
                        <div className="relative">
                            <MdOutlinePerson className="absolute left-3 top-3 text-gray-400" />
                            <input
                                type="text"
                                placeholder="Name"
                                value={name}
                                onChange={(e) => setName(e.target.value)}
                                className="w-full pl-10 p-2 border rounded-md focus:ring-yellow-500 focus:border-yellow-500"
                                required
                            />
                        </div>
                    ...
                    <div className="mt-6 flex justify-center">
                        <button
                            ...
                            type="button"
                            className="flex items-center justify-center w-full py-2 border border-gray-300 rounded-md bg-white text-gray-700 hover:bg-gray-100"
                        >
                            <img
                                src="/google.svg"
                                alt="Google Logo"
